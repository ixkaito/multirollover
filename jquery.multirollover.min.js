...
j=a(this).css("position");c=a(this).css("vertical-align");m=a(this).css("z-index");if(j=="static"||j=="relative"){if(a(this).css("display")=="inline"&&!a(this).parent().hasClass("multirollover-image")){a(this).wrap('<span class="multirollover-image" style="position:relative; display:inline-block;">');
